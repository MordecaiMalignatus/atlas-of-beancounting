...
/// URLs for poe.ninja. These require to be `format!`ed with the league name
/// before use. These are overspecific because the API is locked down pretty
/// tightly -- These are the endpoints that work and I haven't gotten any others
/// to work.
